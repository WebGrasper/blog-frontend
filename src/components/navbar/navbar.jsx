...
import {searchBlogs} from "../../store/searchBlogSlice";
...
function Navbar() {
  ...
  const handleSearchBlogs = debounce(async(value) =>{
    if(value === undefined || value === null || value === ""){
      await dispatch(fetchBlogs());
      return;
    }
    await dispatch(searchBlogs(value));
  },1000);
      ...
      <div className="container-2">
        <form className="container-2-span" method="GET">
          <input
            ...
            placeholder="Search"
            onChange={(e)=> {
              handleSearchBlogs(e.target.value || "all");
            }}
          />
        </form>
      </div>
